...
public class Processor_isLiked_7_Handler implements org.kie.kogito.internal.process.runtime.KogitoWorkItemHandler {

    org.acme.Processor service;

    public Processor_isLiked_7_Handler() {
        this(new org.acme.Processor());
    }

    @javax.inject.Inject()
    public Processor_isLiked_7_Handler(org.acme.Processor service) {
    ...
    public String getName() {
        return "org.acme.Processor_isLiked_7_Handler";
    }
}
