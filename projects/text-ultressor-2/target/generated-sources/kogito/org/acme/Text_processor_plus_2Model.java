...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "text_processor_plus_2", name = "Text_processor_plus_2", hidden = false)
public class Text_processor_plus_2Model implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<Text_processor_plus_2ModelOutput> {
    ...
    @Override()
    public Text_processor_plus_2ModelOutput toModel() {
        Text_processor_plus_2ModelOutput result = new Text_processor_plus_2ModelOutput();
        result.setId(getId());
