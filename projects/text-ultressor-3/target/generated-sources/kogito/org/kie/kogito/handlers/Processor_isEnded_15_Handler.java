...
public class Processor_isEnded_15_Handler implements org.kie.kogito.internal.process.runtime.KogitoWorkItemHandler {

    org.acme.Processor service;

    public Processor_isEnded_15_Handler() {
        this(new org.acme.Processor());
    }

    @javax.inject.Inject()
    public Processor_isEnded_15_Handler(org.acme.Processor service) {
    ...
    public String getName() {
        return "org.acme.Processor_isEnded_15_Handler";
    }
}
