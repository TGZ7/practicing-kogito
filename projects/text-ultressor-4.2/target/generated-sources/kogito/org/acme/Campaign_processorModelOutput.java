...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "campaign_processor", name = "Campaign_processor", hidden = true)
public class Campaign_processorModelOutput implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<Campaign_processorModel> {
    ...
    @Override()
    public Campaign_processorModel toModel() {
        Campaign_processorModel result = new Campaign_processorModel();
        result.setId(getId());
