...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "text_processor_plus", name = "Text_processor_plus", hidden = true)
public class Text_processor_plusModelOutput implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<Text_processor_plusModel> {
    ...
    @Override()
    public Text_processor_plusModel toModel() {
        Text_processor_plusModel result = new Text_processor_plusModel();
        result.setId(getId());
