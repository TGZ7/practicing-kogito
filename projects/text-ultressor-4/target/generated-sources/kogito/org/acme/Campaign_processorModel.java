...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "campaign_processor", name = "Campaign_processor", hidden = false)
public class Campaign_processorModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<Campaign_processorModelOutput> {
    ...
    @Override()
    public Campaign_processorModelOutput toModel() {
        Campaign_processorModelOutput result = new Campaign_processorModelOutput();
        result.setId(getId());
