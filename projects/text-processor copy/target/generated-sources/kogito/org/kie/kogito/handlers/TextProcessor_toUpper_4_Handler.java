...
public class TextProcessor_toUpper_4_Handler implements org.kie.kogito.internal.process.runtime.KogitoWorkItemHandler {

    org.acme.TextProcessor service;

    public TextProcessor_toUpper_4_Handler() {
        this(new org.acme.TextProcessor());
    }

    @javax.inject.Inject()
    public TextProcessor_toUpper_4_Handler(org.acme.TextProcessor service) {
    ...
    public String getName() {
        return "org.acme.TextProcessor_toUpper_4_Handler";
    }
}
